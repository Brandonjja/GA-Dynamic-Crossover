...
public final class Vars {
	...
	// Variables that can be tweaked before execution:
	final static int populationSize = 30;
	final static int maxGenerations = 100000;
	final static float mutationChance = 0.02f;
	final static float crossoverChance = 0.9f;
	
	final static float incrementChance = 0.05f;
	final static float decrementChance = 0.01f;
	final static float upperBound = 0.75f;
	final static float lowerBound = 0.25f;

	final static float runs = 2; // How many times to run the GA

	final static int size = 26; // must match the matrix size

	static int coTimes = 0, mutTimes = 0;
	static int orderTimes = 0, uniformTimes = 0, singlePTimes = 0, twoPTimes = 0, hybridTimes = 0;

	// COC = Crossover Chance
	static double coc_order = 0.5, coc_uniform = 0.5, coc_singlePoint = 0.5, coc_twoPoint = 0.5, coc_hybrid = 0.5;

	static int currentGeneration = 1;

	static List<Integer> randomSearch;
